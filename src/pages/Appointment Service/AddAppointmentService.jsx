...
import { addAppointmentService, resetAppointmentStatus } from '../../store/appointmentSlice';
...
function AddAppointmentService() {
    ...
    const {status, alertData} = useSelector((state)=>state.appointmentData)
    ...
    const handleSubmitBtn = (e) => {
        ...
        dispatch(addAppointmentService(formData));
        ...
        <div class="bg-gradient-to-r from-red-200 to-green-200 p-8 rounded-md w-full">
            <div class=" flex items-center justify-between pb-3">
                <div className='flex'>
                    ...
                    <h2 class="text-blue-800 text-xl font-semibold uppercase">Add Appointment Service</h2>
                </div>
            </div>
            <div className=' '>
                <div class=" border-4 min-h-[450px] rounded-lg shadow relative ">
                        ...
                        <form >
                            <div class="grid gap-y-3 grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select  name="branch" onChange={(e)=>setBranchId(e.target.value)} value={setBranchId} id="branch"  class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"  required>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select  name="appoinment" onChange={(e)=>setAppointmentId(e.target.value)} value={setAppointmentId} id="appoinment"  class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"  required>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select  name="status" onChange={(e)=>setAppointmentStatus(e.target.value)} value={status} id="gender"  class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"  required>
                    ...
                    <div class="p-6 border-t border-gray-200 rounded-b">
                        <button onClick={handleSubmitBtn} class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-xl px-5 py-2.5 text-center" type="submit">Add</button>
                    </div>
                </div>
            </div>
        </div>
