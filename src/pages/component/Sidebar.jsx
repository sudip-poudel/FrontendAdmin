            ...
            <div class="min-h-screen  flex flex-row bg-gray-100" style={{ fontFamily: "'Vanlose BookType', sans-serif" }}>
                <div class="flex flex-col w-80 bg-red-100 text-white  overflow-hidden">
                    ...
                    <ul class="flex pl-4 gap-y-1 flex-col py-4">
                        ...
                        <li>
                            <Link to='/appointments' class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
                                <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-black"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" height={26} width={26} stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
                                    <line x1="16" y1="2" x2="16" y2="6"></line>
                                    <line x1="8" y1="2" x2="8" y2="6"></line>
                                    <line x1="3" y1="10" x2="21" y2="10"></line>
                                    <circle cx="16" cy="16" r="4"></circle>
                                    <path d="M16 14v2l1.5 1.5"></path>
                                </svg></span>
                                <span class="text-xl font-medium">Appointment</span>
                            </Link>
                        </li>
                        <li>
                            <Link to='/payments' class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
                                <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><svg viewBox="0 0 1024 1024" height={26} width={26} class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
                                        <path d="M896 160H128c-35.3 0-64 28.7-64 64v576c0 35.3 28.7 64 64 64h768c35.3 0 64-28.7 64-64V224c0-35.3-28.7-64-64-64z m0 640H128V416h768v384z m0-512H128v-64h768v64z" fill="#0F1F3C"></path>
                                        <path d="M192 480h320v64H192zM192 608h192v64H192z" fill="#0F1F3C"></path>
                                    </g>
                                </svg>
                                </span>
